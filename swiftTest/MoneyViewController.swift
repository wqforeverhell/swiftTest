...
class MoneyViewController: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    func initCollectionView(){
        ...
        cv?.register(MoneyCollectionViewCell .classForCoder(), forCellWithReuseIdentifier: "MoneyCollectionViewCell")
         defaultLayout.itemSize = CGSize(width: kScreenWidth/2, height: 81)
        cv!.dataSource = self
        cv!.delegate = self
